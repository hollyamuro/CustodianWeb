...
const DeleteEmployeeItem = ({
	...
	<div className="component-wrapper-danger">
		...
		<div className="button-wrapper">
			<button className="btn btn-outline-danger round-button" onClick={onItemBtnClicked}>-</button>
		</div>
	</div>
);

DeleteEmployeeItem.propTypes = {
...
DeleteEmployeeItem.defaultProps = {
	employee: {},
	onItemBtnClicked: () => { }
};

export default DeleteEmployeeItem;