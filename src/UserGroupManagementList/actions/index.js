...
export const loadGroups = () => {
	return async (dispatch) => {
		try {
			...
			const result =
				await axios.post(
					location.protocol + "//" + location.host + "/S099C001F002/read", { data: {} });
...
export const createGroup = () => {
	return async (dispatch, getState) => {
		try {
			...
			// do request
			const result =
				await axios.post(location.protocol + "//" + location.host + "/S099C001F002/create", { data: getState().createdGroup });
...
export const setCreateGroupName = (g_name) => {
	return {
...
export const setCreateGroupDescription = (g_description) => {
	return {
...
export const setCreateGroupRole = (g_role) => {
	return {
...
export const setCreateGroupProduct = (g_product) => {
	return {
...
export const updateGroup = (id) => {
	return async (dispatch, getState) => {
		try {
			...
			const result =
				await axios.post(
					location.protocol + "//" + location.host + "/S099C001F002/update",
					{ data: getState().groups.filter((g) => { return (g.g_id === id); })[0] }
				);
...
export const setUpdateGroupName = (id, g_name) => {
	return {
...
export const setUpdateGroupDescription = (id, g_description) => {
	return {
...
export const setUpdateGroupRole = (id, g_role) => {
	return {
...
export const setUpdateGroupProduct = (id, g_product) => {
	return {
...
export const deleteGroup = (id) => {
	return async (dispatch, getState) => {
		try {
			...
			const result =
				await axios.post(
					location.protocol + "//" + location.host + "/S099C001F002/delete",
					{ data: getState().groups.filter((g) => { return (g.g_id === id); })[0] }
				);
