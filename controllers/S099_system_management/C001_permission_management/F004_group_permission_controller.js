...
/**
 * 群組權限管理
 * @module controllers/S099_system_management/C001_permission_management/F004_group_permission_controller
 */
...
module.exports.init = async (req, res, next) => {
	try {
		...
		// set page
		res.render("S099_system_management/C001_permission_management/F004_group_permission", {
			// default
...
module.exports.read = async (req, res, next) => {
	try {
		...
		if(isInputDataVaild){
			const result = await axios.post(local + "/api/staff/group_permissions/read", { 
				"data": req.body.data, 
...
module.exports.create = async (req, res, next) => {
	try {
		...
		let isInputDataVaild = await utility.checkInputData(req.body.data);
		if(isInputDataVaild){
			const result = await axios.post(local + "/api/staff/group_permissions/create", { 
				"data": req.body.data, 
				"requester": req.user_profile.user,
				"token": req.cookies.custodianweb_access_token,
				"system": "CustodianWeb",
...
module.exports.delete = async (req, res, next) => {
	try {
		...
		let isInputDataVaild = await utility.checkInputData(req.body.data);
		if(isInputDataVaild){
			const result = await axios.post(local + "/api/staff/group_permissions/delete", { 
				"data": req.body.data, 
				"requester": req.user_profile.user,
				"token": req.cookies.custodianweb_access_token,
				"system": "CustodianWeb",
